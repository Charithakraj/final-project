            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item "><span>2</span><a href="#"  data-kn="ನಿಮ್ಮ ನೆಚ್ಚಿನ ಆಹಾರವನ್ನು ಆರಿಸಿ" data-en="Pick Your favorite food">Pick Your favorite food</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active" ><span>3</span><a href="checkout.php"  data-kn="ಆರ್ಡರ್ ಮಾಡಿ ಮತ್ತು ಪಾವತಿಸಿ" data-en="Order and Pay">Order and Pay>Order and Pay</a></li>
                    </ul>
                </div>
            </div>
