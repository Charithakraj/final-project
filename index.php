        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1 data-kn="ಲಾಗ್ ಔಟ್" data-en="Order Delivery & Take-Out">Order Delivery & Take-Out </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span data-kn="ರೆಸ್ಟೋರೆಂಟ್ ಆಯ್ಕೆಮಾಡಿ" data-en="Choose Restaurant">Choose Restaurant</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span data-kn="ಆಹಾರವನ್ನು ಆರ್ಡರ್ ಮಾಡಿ" data-en="Order Food">Order Food</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span data-en="Delivery or take out" data-kn="ಡೆಲಿವರಿ ಅಥವಾ ಟೇಕ್ ಔಟ್" >Delivery or take out </h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2 data-kn="ತಿಂಗಳ ಜನಪ್ರಿಯ ಭಕ್ಷ್ಯಗಳು" data-en="Popular Dishes of the Month">Popular Dishes of the Month></h2>
                    <p class="lead" data-kn="ತಿಂಗಳ ಜನಪ್ರಿಯ ಭಕ್ಷ್ಯಗಳು" data-en="Popular Dishes of the Month">Popular Dishes of the Month</p>
                </div>
                <div class="row">
						<?php 					
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2 data-kn="ಆರ್ಡರ್ ಮಾಡಲು ಸುಲಭ" data-en="Easy to Order">Easy to Order</h2>
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3 data-kn="ರೆಸ್ಟೋರೆಂಟ್ ಆಯ್ಕೆಮಾಡಿ" data-en="Choose a restaurant">Choose a restaurant></h3>
                                    <p  data-kn="ಆನ್ ಲೈನ್ ನಲ್ಲಿ ವಿವಿಧ ವಿತರಣಾ ರೆಸ್ಟೋರೆಂಟ್ ಗಳಿಂದ ಮೆನುಗಳೊಂದಿಗೆ ನಿಮ್ಮ ಕವರ್ ಅನ್ನು ನಾವು ಹೊಂದಿದ್ದೇವೆ" data-en="We've got your covered with menus from a variety of delivery restaurants online">We"ve got your covered with menus from a variety of delivery restaurants online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3 data-kn="ಖಾದ್ಯವನ್ನು ಆಯ್ಕೆಮಾಡಿ" data-en="Choose a dish">Choose a dish</h3>
                                <p  data-kn="ಆನ್ ಲೈನ್ ನಲ್ಲಿ ವಿವಿಧ ವಿತರಣಾ ರೆಸ್ಟೋರೆಂಟ್ ಗಳಿಂದ ಮೆನುಗಳೊಂದಿಗೆ ನಿಮ್ಮ ಕವರ್ ಅನ್ನು ನಾವು ಹೊಂದಿದ್ದೇವೆ" data-en="We've got your covered with menus from a variety of delivery restaurants online">We"ve got your covered with a variety of delivery restaurants online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3 data-kn="ಪಿಕ್ ಅಪ್ ಅಥವಾ ಡೆಲಿವರಿ" data-en="Pick up or Delivery">Pick up or Delivery></h3>
                                <p data-kn="ನಿಮ್ಮ ಆಹಾರವನ್ನು ತಲುಪಿಸಿ! ಮತ್ತು ನಿಮ್ಮ ಊಟವನ್ನು ಆನಂದಿಸಿ!"  data-en="Get your food delivered! And enjoy your meal!" >Get your food delivered! And enjoy your meal! </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info" data-kn="ಕ್ಯಾಶ್ ಆನ್ ಡೆಲಿವರಿ" data-en="Cash on Delivery" >Cash on Delivery</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4 data-kn="ವಿಶೇಷ ರೆಸ್ಟೋರೆಂಟ್ ಗಳು" data-en="Featured restaurants">Featured restaurants</h4> </div>
                    </div>
                    <div class="col-sm-8">
